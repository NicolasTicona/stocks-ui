...
locals {
  s3_origin_id = "stock-ui-deployment-bucket.sandbox.com"
}

resource "aws_cloudfront_origin_access_identity" "origin_access_identity" {
  comment = "OAI for stock-ui-deployment-bucket.sandbox.com"
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  comment             = "cloudfront for stock-ui-deployment-bucket.sandbox.com"
